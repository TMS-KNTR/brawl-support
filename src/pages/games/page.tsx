        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "mainEntity": [
            ...
            },
            {
              ...
              "acceptedAnswer": { "@type": "Answer", "text": "トロフィー上げ代行は1,000トロフィーまではパワーレベル不問、1,001トロフィー以上はパワー11キャラのみ対応です。ガチバトル代行のエリート帯以上は、今月の最大レベルキャラを含めパワー11キャラを12体以上所持している必要があります。" }
            },
            {
              "@type": "Question",
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                a: 'トロフィー上げ代行は1,000トロフィーまではパワーレベル不問、1,001トロフィー以上はパワー11キャラのみ対応です。ガチバトル代行のエリート帯以上は、今月の最大レベルキャラを含めパワー11キャラを12体以上所持している必要があります。',
              },
              {
