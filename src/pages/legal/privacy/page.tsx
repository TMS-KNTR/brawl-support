      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="prose prose-lg max-w-none">
          ...
          <div className="text-gray-700 mb-6 space-y-2">
            ...
            <p>3. 決済サービス（Stripe社）を通じて取得する決済に関する情報</p>
          </div>
          ...
          <div className="text-gray-700 mb-6 space-y-2">
            ...
            <p>2. <strong>注文情報</strong> — 注文内容、ゲームアカウント情報（代行に必要な範囲のみ）</p>
            <p>3. <strong>決済情報</strong> — Stripe社を通じた決済記録（クレジットカード番号・PayPay等の決済情報は当サービスのサーバーには一切保存されません）</p>
          ...
          <div className="text-gray-700 mb-6 space-y-2">
            <p>当サービスは、ユーザーの個人情報を適切に管理し、以下のいずれかに該当する場合を除き、個人情報を第三者に開示しません。</p>
            <p>当サービスでは、個人情報の正確性を保ち、これを安全に管理するために以下の措置を講じています。</p>
          ...
          <div className="text-gray-700 mb-6 space-y-2">
            ...
            <p>5. 決済処理に必要な範囲でStripe社に提供する場合</p>
            <p>6. 代行サービスの履行に必要な範囲で代行者に注文情報を開示する場合</p>
            <p>7. 合併その他の事由による事業の承継に伴い個人情報を提供する場合</p>
          </div>

          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">第7条（決済情報の取扱い）</h2>
          <div className="text-gray-700 mb-6 space-y-2">
            <p>当サービスでは、決済処理にStripe社のシステムを利用しています。決済情報の取扱いについて以下のとおり定めます。</p>
            <p>1. クレジットカード番号、PayPay等の決済手段に関する情報は、当サービスのサーバーには一切保存されません</p>
            <p>2. すべての決済情報はStripe社により安全に管理されます</p>
            <p>3. Stripe社はPCI DSS（Payment Card Industry Data Security Standard）に準拠した高いセキュリティ基準で決済情報を保護しています</p>
            <p>4. Stripe社のプライバシーポリシーについては、同社のウェブサイトをご確認ください</p>
          </div>

          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">第8条（ゲームアカウント情報の取扱い）</h2>
          <div className="text-gray-700 mb-6 space-y-2">
            <p>代行サービスの提供に必要なゲームアカウント情報については、以下のとおり管理します。</p>
            <p>1. 代行作業に必要な最小限の情報のみを代行者に開示します</p>
            <p>2. 代行者は受領したゲームアカウント情報をサービスの履行以外の目的で使用してはなりません</p>
            <p>3. 作業完了後は、速やかにアクセス権を無効化することを推奨します</p>
            <p>4. ゲームアカウント情報は、当サービス外の目的で利用いたしません</p>
          </div>
