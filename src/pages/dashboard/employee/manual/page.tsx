    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          description: '受注が完了したら、必ずチャット入力欄の 🛡️ ボタンを押して、依頼者にアカウント連携手順を送信してください。',
          items: [
          ...
          warning: 'このボタンを押し忘れると依頼者がどう対応すればよいか分からず、取引が停滞します。必ず受注直後に送信してください。',
