  ...
  const sections = [
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            'ダッシュボードの「口座を登録」から銀行口座情報を入力してください。',
            '登録完了後、ダッシュボードに戻ります。',
          ],
          table: {
            headers: ['ステータス', '意味'],
    ...
    },
    {
      ...
      content: [
        ...
        {
          subtitle: '受注直後：連携手順の送信',
          description: '🛡️ ボタンで連携手順を一括送信できます。受注直後の送信を推奨します。',
          items: [
            '受注完了後、自動作成されたチャット画面を開きます。',
            'チャット入力欄の画像添付ボタンの右にある盾アイコン（🛡️）をクリックします。',
            '5ステップ分のメッセージ（画像付き）が順次依頼者に送信されます。',
            '依頼者がメールアドレスと認証コードを返信するのを待ちます。',
          ],
          warning: '送信しないと依頼者の連携が進まず、取引が停滞しがちです。',
          note: '個別の案内が必要な場合は、テンプレ送信後に追加メッセージで補足してください。',
        },
        {
          subtitle: '報酬について',
          items: [
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          subtitle: '① 作業開始',
          items: [
            '受注直後に送信した連携手順に沿って、依頼者からメールアドレスと認証コードを受け取ります。',
            'ログインが完了したら「自分の案件」タブまたは案件詳細ページを開きます。',
            '「作業開始」ボタンをクリックします。',
            '依頼者に作業開始の通知が届きます。',
          ],
        },
        {
          ...
          items: [
            '依頼内容に従って作業を進めます。',
            '進捗報告・質問はチャット機能の利用を推奨します。',
            '問題発生時は早めにサポートに連絡してください。',
          ],
        },
        {
          subtitle: '③ 作業完了',
          ...
          note: '目標達成スクショの送付は、完了確認をスムーズにしトラブル防止に役立ちます。',
        },
      ],
    },
    {
      ...
      content: [
        ...
        {
          subtitle: '連携手順テンプレート送信（🛡️ ボタン）',
          description: 'チャット入力欄の盾アイコン（🛡️）を押すと、ブロスタのアカウント連携手順（5ステップ・画像付き）を依頼者に一括送信できます。',
          items: [
            '受注直後に依頼者へ送信するのが基本的な使い方です（セクション 3「受注直後：連携手順の送信」を参照）。',
            'ボタンは受注済の案件のチャット画面でのみ表示されます。',
            '送信しないと依頼者が連携できず止まります。',
          ],
        },
        {
          subtitle: 'チャットでの禁止行為',
      ...
      content: [
        {
          faq: [
            ...
            { q: '出金にはどのくらい時間がかかりますか？', a: '管理者の承認後、登録済みの銀行口座に振り込まれます。通常数営業日程度です。' },
