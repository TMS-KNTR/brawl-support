...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: '全額返金保証があります。依頼した目標が達成されなかった場合、お支払い金額を全額返金いたします。エスクロー方式を採用しているため、代行完了が確認されるまで代金は安全に保全されます。',
    },
    {
    ...
    },
    {
      icon: 'ri-user-line',
      q: '依頼後にアカウントは使えますか？',
      a: '代行期間中はアカウントをご利用いただけません。代行者がログインして作業を行うため、完了までアカウントの使用はお控えください。完了後は通常通りご利用いただけます。',
    },
  ];
